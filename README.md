...
### 一、项目演示地址（点击链接就可以看到）：
https://www.bilibili.com/video/BV1HfAjeEEhx/?spm_id_from=333.1387.search.video_card.click&vd_source=c01eb631d21f3b1ec41e350c824e10cc

### 二、获取地址:

### 项目获取地址：https://www.666bear.com/9938.html
...
管理员：管理员进入主页面，主要功能包括对系统首页、用户管理、风格管理、场合管理、品牌管理、颜色管理、服装搭配管理、系统管理、我的信息 等进行操作。

用户：当游客微信小程序的网址后，首先看到的就是首页界面。在这里，游客能够看到微信小程序的年轻女性服装搭配系统的低部导航条显示首页、服装搭配、我的等，
